...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["2347082526217", "2347082180195"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["2347082526217", "2347082180195"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["2347082526217"];
global.OwnerName = process.env.OWNER_NAME || "LeonaCreatives";
